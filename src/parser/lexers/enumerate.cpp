// src/lib/parser/lexers/enumerate.cpp
// v. 0.1.0
//
// Author: Cayden Lund
//   Date: 10/06/2021
...
namespace mark_sideways
{
    ...
    namespace lexers
    {
        ...
        mark_sideways::lexers::Enumerate::Enumerate(mark_sideways::State *state) : Lexer(state)
        {
        ...
        {
            return "[%%==ENUMERATE_" + std::to_string(level) + "==%%]";
        }
    }
}
