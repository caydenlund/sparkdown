...
namespace sparkdown
{
    ...
    namespace lexers
    {
        ...
        sparkdown::lexers::Enumerate::Enumerate(sparkdown::State *state) : AbstractLexer(state)
        {
        ...
        bool sparkdown::lexers::Enumerate::is_enumerate(const std::string &line)
        {
        ...
        std::vector<sparkdown::Token> sparkdown::lexers::Enumerate::lex(const std::string &line)
        {
            ...
            else
            {
                ...
                if (std::regex_match(line, this->match_regex))
                {
                    ...
                    tokens.push_back(sparkdown::Token(sparkdown::Token::token_type::ENUMERATE, std::to_string(bullet_point_level)));
